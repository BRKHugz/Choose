...
Sugestões de veículos que mais combinam com o perfil do usuário;
Interface intuitiva e responsiva;
Funcionalidade de perguntas e recomendações automáticas;
...
imagem do Diagrama de Atividde:
...
Link e Imagem da tela do Trello:
